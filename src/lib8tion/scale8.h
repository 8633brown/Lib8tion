...
/// In place modifying version of scale8_video, also this version of
/// nscale8_video does not clean up the R1 register on AVR If you are doing
/// several 'scale8_video's in a row, use this, and then explicitly call
/// cleanup_R1.
